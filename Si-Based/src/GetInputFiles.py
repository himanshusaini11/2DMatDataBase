...
K_POINTS {crystal_b}
6 
   0.500000000 0.250000000 0.750000000 30 ! W
   0.000000000 0.000000000 0.000000000 30 ! G
   0.500000000 0.000000000 0.500000000 30 ! X
   0.500000000 0.250000000 0.750000000 30 ! W
   0.500000000 0.500000000 0.500000000 30 ! L
   0.000000000 0.000000000 0.000000000 30 ! G 
...
def OpticalSCF(path, DataBaseFolder, Folder, Property, MatName, CELLDM, IBRAV, NAT, NTYP, ATOMIC_POSITIONS):
    readpath = path + '/%s/%s/%s/%s' %(DataBaseFolder, Folder, MatName, Property)
    os.chdir(readpath)
