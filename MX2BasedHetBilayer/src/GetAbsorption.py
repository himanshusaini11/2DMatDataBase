...
class OpticalProperties:
    ...
    def DielectricFunction(self):
        readpath = self.path + '/MaterialsDataBase/OpticalProperties/' + self.mat
        os.chdir(readpath)
    ...
    def Absorbance(self):
        ...
        #if (self.polarization == 'x' or self.polarization == 'X'):
        #    Absorbance = np.multiply((np.divide((np.multiply((omega), (imag_part[:, 1]))), (2.99792458E+8))), (self.deltaZ))
        #elif (self.polarization == 'y' or self.polarization == 'Y'):
