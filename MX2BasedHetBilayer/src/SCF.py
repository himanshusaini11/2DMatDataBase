...
def AddFile(mat, a, calulation, pseudo_dir, prefix, ecutwfc, ecutrho, vdw_corr, AtomicCoordinates, CellParameters):
    path = os.getcwd()
    #CompoundName = mat
    ...
    inputdata = InputFile(mat, calulation, pseudo_dir, prefix, celldm1, nat, ntyp, ecutwfc, ecutrho, vdw_corr, cell_parameters, atomic_species, atomic_positions)
